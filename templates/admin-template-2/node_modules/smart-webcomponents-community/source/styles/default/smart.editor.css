...
.smart-editor.preview-mode .smart-editor-toolbar-item:not([item-name="print"]):not([item-name="sourcecode"]):not([item-name="fullscreen"]) {
  -moz-user-select: none;
  -ms-user-select: none;
  -webkit-user-select: none;
  user-select: none;
...
.smart-editor .smart-editor-toolbar:not(.smart-tooltip):not([expanded]) .smart-editor-toolbar-items-primary {
  overflow: hidden;
}
...
.smart-editor[show-char-count] .smart-editor-content-container::after {
  ...
  bottom: var(--smart-editor-chart-counter-offset);
  right: var(--smart-editor-chart-counter-offset);
  box-sizing: border-box;
...
.smart-editor[focus] .smart-editor-toolbar-item[checked] {
...
.smart-editor-toolbar-item:hover {
...
.smart-editor-toolbar-item:not([item-type="color-input"]):not([disabled]):active {
  color: var(--smart-ui-state-color-active);
  border-color: var(--smart-ui-state-border-active);
  background-color: var(--smart-ui-state-active);
}

...
$primary:       darken($blue, 15) !default;
$secondary:     darken($gray-600, 15) !default;
$success:       darken($green, 15) !default;
$info:          darken($cyan, 15) !default;
$warning:       darken($yellow, 15) !default;
$danger:        darken($red, 15) !default;
...
$modal-content-box-shadow-xs:       0 .25rem .5rem rgba($white, .5);
$modal-content-box-shadow-sm-up:    0 .5rem 1rem rgba($white, .5);

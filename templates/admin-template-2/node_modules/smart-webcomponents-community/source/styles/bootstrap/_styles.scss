...
smart-scheduler {
  * {
  ...
  &:not(.bordered) {
    --smart-scheduler-day-week-view-vertical-line-color: transparent; /* Vertical timeline color in 'day' and 'week' views */
  }

  &.bordered {
    --smart-scheduler-day-week-view-vertical-line-color: #{$table-border-color}; /* Vertical timeline color in 'day' and 'week' views */
  }
  ...
  &.table-secondary,
  &.table-dark {
    --smart-scheduler-day-week-view-vertical-line-color: #{$table-dark-border-color}; /* Vertical timeline color in 'day' and 'week' views */
...
body[theme="dark"] {
  .smart-alert {
    @each $name, $hex in $theme-colors {
      &.smart-alert-#{$name} {
        @include lighten-color(23, $hex, 'color');
        @include darken-color(20, $hex, 'background-color');
        @include darken-color(36, $hex, 'border-color');
      }
    }
  }
}
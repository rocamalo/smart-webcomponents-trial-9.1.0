...
body[theme=dark] {
  ...
  --smart-surface: #212529;
  --smart-surface-color: #b8b7b7;
  --smart-background: #212529;
  /* The theme background color. The background color appears behind scrollable content.*/
  --smart-background-color: #b8b7b7;
  ...
  --smart-circular-progress-bar-default-size: 13px;
...
/* BUTTON */
smart-button button.smart-button, smart-button a.smart-button,
...
smart-repeat-button.primary {
  ...
  --smart-ui-state-hover: #083463;
  --smart-ui-state-border-hover: #072e57;
  --smart-ui-state-active: #083463;
  --smart-ui-state-border-active: #072e57;
  --smart-ui-state-focus: #083463;
  --smart-ui-state-border-focus: #072e57;
}
...
smart-repeat-button.secondary {
  ...
  --smart-button-opacity-focus: 1;
  --smart-button-opacity-active: 1;
  --smart-ui-state-hover: #373b3f;
  --smart-ui-state-border-hover: #313539;
  --smart-ui-state-active: #373b3f;
  --smart-ui-state-border-active: #313539;
  --smart-ui-state-focus: #373b3f;
  --smart-ui-state-border-focus: #313539;
}
...
smart-repeat-button.success {
  ...
  --smart-button-opacity-focus: 1;
  --smart-button-opacity-active: 1;
  --smart-ui-state-hover: #124a1f;
  --smart-ui-state-border-hover: #0f401b;
  --smart-ui-state-active: #124a1f;
  --smart-ui-state-border-active: #0f401b;
  --smart-ui-state-focus: #124a1f;
  --smart-ui-state-border-focus: #0f401b;
}
smart-button.info,
...
smart-repeat-button.info {
  ...
  --smart-button-opacity-focus: 1;
  --smart-button-opacity-active: 1;
  --smart-ui-state-hover: #0a4852;
  --smart-ui-state-border-hover: #093e47;
  --smart-ui-state-active: #0a4852;
  --smart-ui-state-border-active: #093e47;
  --smart-ui-state-focus: #0a4852;
  --smart-ui-state-border-focus: #093e47;
}
...
smart-repeat-button.warning {
  ...
  --smart-button-opacity-focus: 1;
  --smart-button-opacity-active: 1;
  --smart-ui-state-hover: #936e00;
  --smart-ui-state-border-hover: #876500;
  --smart-ui-state-active: #936e00;
  --smart-ui-state-border-active: #876500;
  --smart-ui-state-focus: #936e00;
  --smart-ui-state-border-focus: #876500;
}
smart-button.error,
...
smart-repeat-button.error {
  ...
  --smart-button-opacity-focus: 1;
  --smart-button-opacity-active: 1;
  --smart-ui-state-hover: #871722;
  --smart-ui-state-border-hover: #7c151f;
  --smart-ui-state-active: #871722;
  --smart-ui-state-border-active: #7c151f;
  --smart-ui-state-focus: #871722;
  --smart-ui-state-border-focus: #7c151f;
}
smart-button.light,
...
smart-repeat-button.link {
  ...
  --smart-border-rgb: 10, 71, 134;
  --smart-background-color: #0a4786;
  --smart-ui-state-hover: transparent;
  --smart-ui-state-border-hover: transparent;
  --smart-ui-state-color-hover: #0a4786;
  --smart-ui-state-active: transparent;
  --smart-ui-state-border-active: transparent;
  --smart-ui-state-color-active: #0a4786;
  --smart-ui-state-focus: transparent;
  --smart-ui-state-border-focus: transparent;
  --smart-ui-state-color-focus: #0a4786;
  --smart-button-flat-color: #0a4786;
  --smart-button-outlined-color: #0a4786;
...
.smart-button-group.warning .smart-button-group-items .smart-button-group-item[hover], .smart-button-group.warning .smart-button-group-items .smart-button-group-item:hover {
  background-color: #7a5b00 !important;
}
...
.smart-button-group.error .smart-button-group-items .smart-button-group-item[hover], .smart-button-group.error .smart-button-group-items .smart-button-group-item:hover {
  background-color: #71141d !important;
}
...
.smart-accordion .smart-accordion-item:hover .smart-accordion-item-header, .smart-accordion .smart-accordion-item[hover] .smart-accordion-item-header, .smart-accordion .smart-accordion-item[focus] .smart-accordion-item-header, .smart-accordion .smart-accordion-item[focused] .smart-accordion-item-header, .smart-accordion .smart-accordion-item[expanded] .smart-accordion-item-header {
  background: rgba(184, 183, 183, 0.03);
}
...
.smart-accordion .smart-accordion-item .smart-container {
  border: 1px solid rgba(184, 183, 183, 0.125);
}
...
smart-card.card .card-header {
  padding: 0.75rem 1.25rem;
  margin-bottom: 0;
  background-color: rgba(184, 183, 183, 0.03);
  border-bottom: 1px solid rgba(184, 183, 183, 0.125);
}
...
smart-card.card .card-footer {
  padding: 0.75rem 1.25rem;
  background-color: rgba(184, 183, 183, 0.03);
  border-top: 1px solid rgba(184, 183, 183, 0.125);
}
...
.smart-toast-item.bootstrap {
  ...
  background-color: rgba(184, 183, 183, 0.85);
  color: #343a40;
}
...
smart-progress-bar:not([orientation=vertical]),
smart-circular-progress-bar:not([orientation=vertical]) {
  width: 100%;
}
smart-progress-bar:not(.smart-circular-progress-bar),
smart-circular-progress-bar:not(.smart-circular-progress-bar) {
  background-color: #e9ecef !important;
}
...
.smart-query-builder .filter-builder-item.smart-filter-field-name[edited], .smart-query-builder .filter-builder-item.smart-filter-field-name:focus, .smart-query-builder .filter-builder-item.smart-filter-operation[edited], .smart-query-builder .filter-builder-item.smart-filter-operation:focus, .smart-query-builder .filter-builder-item.smart-filter-value[edited], .smart-query-builder .filter-builder-item.smart-filter-value:focus {
  --smart-border: #0a4786;
  --smart-outline: #0a4786;
  box-shadow: 0 0 0 0.2rem rgba(10, 71, 134, 0.25);
}
.smart-query-builder .filter-builder-item .smart-filter-value {
  box-shadow: unset !important;
}
...
.smart-list-box[selection-mode=checkBox] .smart-list-item[focus] .smart-input {
  --smart-border: #0a4786;
  --smart-outline: #0a4786;
  box-shadow: 0 0 0 0.2rem rgba(10, 71, 134, 0.25) !important;
}
...
/* SORTABLE LIST */
.smart-sortable ul, .smart-sortable ol {
  display: -ms-flexbox;
  display: flex;
...
.smart-sortable ul li, .smart-sortable ol li {
  position: relative;
  display: block;
  padding: 0.75rem 1.25rem;
  background-color: #212529;
...
.smart-sortable ul li:first-child, .smart-sortable ol li:first-child {
  border-top-left-radius: 0.25rem;
  border-top-right-radius: 0.25rem;
}
.smart-sortable ul li:last-child, .smart-sortable ol li:last-child {
  border-bottom-left-radius: 0.25rem;
  border-bottom-right-radius: 0.25rem;
}
.smart-sortable ul li + li, .smart-sortable ol li + li {
  border-top-width: 0;
}
...
/* DROPDOWN LIST */
.smart-drop-down-list .smart-list-box .smart-list-items-inner-container {
  width: 100% !important;
}
...
.smart-grid [check-boxes_visible] [has-toggle-button] .smart-input:not(.smart-grid-cell-editor):hover[focus] {
  box-shadow: 0 0 0 0.25rem #0a4786;
  /*Fallback */
  box-shadow: 0 0 0 0.25rem rgba(10, 71, 134, 0.25);
}
...
.smart-menu[aria-orientation=horizontal] {
  ...
  --smart-surface-color: rgba(255, 255, 255, 0.9);
  border: 0 !important;
  padding: 0.5rem 1rem;
}
...
smart-password-text-box.smart-password-text-box.smart-validation-success:not(smart-check-box) > div.smart-container:after, smart-password-text-box.smart-password-text-box.smart-validation-error:not(smart-check-box) > div.smart-container:after,
...
smart-password-text-box.smart-password-text-box.smart-validation-success .smart-input, smart-password-text-box.smart-password-text-box.smart-validation-error .smart-input,
...
smart-input.smart-input.smart-validation-success[focus] {
  box-shadow: 0 0 0 0.2rem rgba(25, 105, 44, 0.25);
}
...
smart-input.smart-input.smart-validation-error[focus] {
  box-shadow: 0 0 0 0.2rem rgba(167, 29, 42, 0.25);
}

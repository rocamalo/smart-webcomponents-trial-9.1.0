...
export class Grid extends React.Component<React.HTMLAttributes<Element> & GridProps, any> {   
  ...
  */
	...
	* @returns {any}
  */
	public async highlightCell(rowId:string | number, dataField:string, className?:string) : Promise<any> {
		const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
                    const result = this.nativeElement.highlightCell(rowId, dataField, className);
                    resolve(result)
                });
            });
        };
	...
	* @returns {any}
  */
	public async highlightRow(rowId:string | number, className?:string) : Promise<any> {
		const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
                    const result = this.nativeElement.highlightRow(rowId, className);
                    resolve(result)
                });
            });
        };

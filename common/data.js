...
function getKanbanData(locale = 'en') {
    const text = {
        en: [
            'Tarea de inglés', 'Displaying data from data source', 'Showing cover and title', 'Property validation',
            'formatFunction and formatSettings', 'Examen de español', 'Virtual scrolling', 'Deferred scrolling',
            'Tarea de geografía', 'Visible/hidden columns', 'Public methods', 'Tarea de matemáticas',
